#!/bin/bash
PATH_IMG=./result/win19dcru.raw				 #Selecting output image path
PATH_MNT=/mnt/win2019dcru				 #Selecting PATH where we mount all images (ISO, RAW)
...
PATH_ELEMENT=./elements/win2019_ru_base/		 #Path to first element. You can add more than one. Element - the collection of settings that will be applied to image.
PATH_UNATTENDXML=./elements/win2019_ru_base/Unattend.xml #Path to Unattend.xml file to skip OOBE and set the first configuration on boot
