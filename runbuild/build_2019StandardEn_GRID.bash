#!/bin/bash
PORT_SPICE=5900
PATH_IMG=./result/win19sten_grid.raw				 #Selecting output image path
...
PATH_UNATTENDXML=./elements/win2019_st_en_base/Unattend.xml #Path to Unattend.xml file to skip OOBE and set the first configuration on boot
