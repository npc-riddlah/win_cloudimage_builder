...
./scripts/createImage.bash -i $PATH_IMG -m $PATH_MNT -s $VAR_SIZE -S 50G -I $PATH_ISO -w $PATH_PE -n "$VAR_NAME" -e $PATH_ELEMENT -u $PATH_UNATTENDXML -r $PATH_RUNNER -e ./elements/cloudbase-init/ -e ./elements/grid -e ./elements/virtio -e ./elements/baremetaldrv -e ./elements/chrome -e ./elements/chrome
exit 0
